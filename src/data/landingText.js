...
export const LANDING_FEATURES = [
  {
    ...
    desc: '제작부터 운영·광고·관리까지 하나의 플랜으로 해결합니다.',
    icon: '🔗',
  },
  {
    title: '합리적인 비용',
    desc: '퀄리티를 타협하지 않으면서 소상공인이 부담 없이 시작할 수 있는 가격.',
    icon: '💰',
  },
  {
    title: '24시간 상담 가능',
    desc: '언제든 문의하시면 빠르게 답변드립니다. 연중무휴 운영.',
    icon: '📞',
  },
  {
    title: '제작 후 운영 관리',
    desc: '홈페이지 오픈 이후에도 지속적으로 관리하고 업데이트합니다.',
    icon: '🛠️',
  },
  {
    title: '광고 연동 지원',
    desc: '네이버·당근 광고와 홈페이지를 연동해 효율적인 광고 집행을 지원합니다.',
    icon: '📢',
  },
];
